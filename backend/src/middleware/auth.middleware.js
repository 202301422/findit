...
export const authenticate = async (req, res, next) => {
    try {
        ...
        const user = await User.findById(decoded.id).select("_id name email phone username avatar bio college city state country isVerified authProvider accountStatus role savedPosts following followers");
