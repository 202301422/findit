...
export const getCurrentUser = asyncHandler(async (req, res) => {
  const user = await User.findById(req.user._id).select("_id name email phone username avatar avatarPublicId bio college city state country isVerified authProvider accountStatus role savedPosts following followers createdAt updatedAt");
